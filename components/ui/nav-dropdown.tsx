          ...
          >
              ...
              {items.map((item, idx) => (
                ...
                >
                  <div className="w-full">
                    {item.href ? (
                      <Link to={item.href} className="flex gap-4 items-start w-full">
                        {isMega && item.icon && (
            ...
            {isMega && (
              <div className="mt-2 pt-2 border-t border-slim border-border px-4 py-2">
                <Link to="#" className="text-xs font-bold text-muted-foreground hover:text-primary transition-colors flex items-center gap-1">
